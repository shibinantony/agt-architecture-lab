...
Third-party packages are installed from package distributions or the specified immutable upstream source; their source and binaries are not vendored in this repository. Each package retains its own copyright notices and license. The direct dependencies below were checked against distribution metadata, included license files and pinned upstream source on 2026-09-11.

| Package | Version | Used for | Declared license | Upstream reference |
|---|---|---|---|---|
| pip | 26.2.1 | Isolated-environment package installer | MIT | [Versioned package](https://pypi.org/project/pip/26.2.1/), [source](https://github.com/pypa/pip) |
| setuptools | 83.0.0 | Isolated-environment build tooling | MIT | [Versioned package](https://pypi.org/project/setuptools/83.0.0/), [source](https://github.com/pypa/setuptools) |
| pip-audit | 2.10.1 | Separate dependency-advisory scanner | Apache-2.0 | [Versioned package](https://pypi.org/project/pip-audit/2.10.1/), [source](https://github.com/pypa/pip-audit) |
...
| Microsoft Agent Governance Toolkit core | Source version 5.0.0 at `0533ceaf6c5b0975bfc71bff42f6ccd2d34c8adf` | Separate actual-AGT example; development snapshot, not the PyPI 5.0.0 wheel | MIT | [Pinned source and license](https://github.com/microsoft/agent-governance-toolkit/tree/0533ceaf6c5b0975bfc71bff42f6ccd2d34c8adf), [example scope](examples/upstream-agt/README.md) |
| cryptography | 50.0.1 | Explicit security pin for the upstream example | Apache-2.0 OR BSD-3-Clause | [Versioned package](https://pypi.org/project/cryptography/50.0.1/), [licensing](https://cryptography.io/en/latest/faq/#what-license-is-cryptography-distributed-under) |
