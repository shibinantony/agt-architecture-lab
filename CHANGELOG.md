...
- Added a working YAML policy emulator, synthetic cloud tools, local evidence, budget/approval controls and security tests.
- Added Codex/Gemini MCP setup, a stdio server and actual protocol integration tests.
...
- Initial product README and executive brief.
- PROVE governance method and Governance Decision Contract schema.
- Reference architecture, implementation, onboarding, FinOps, operating, challenge, maturity, control, learning, and source documents.
- Initial Azure Resource Graph query examples.
- Repository validation script.
- GitHub Actions workflow for required-file, JSON, encoding, and local-link checks.
